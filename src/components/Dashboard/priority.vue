            ...
            <div class="col-md-4 offset-md-0 col-sm-8 offset-sm-2 col-10 offset-1">
                <div class="row mb-5">
                 ...
                 <!-- <div class="mb-3">
                            ...
                            <div class="mt-3">
                            <div>
                                <button type="button" class="btn-danger" @click="deleteWeight" style="width: 100px">Delete</button>
                            </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="accordion" id="accordionExample1">
                            ...
                            <!-- <div class="accordion-item">
                                <h2 class="accordion-header" id="headingFour">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwoS" aria-expanded="false" aria-controls="collapseOne">
                                        Custom Receiver
                                    </button>
                                </h2>
                                <div id="collapseTwoS" class="accordion-collapse collapse" aria-labelledby="headingFour" data-bs-parent="#accordionExample1">
                                    <div class="accordion-body"> -->
                                         <!-- <div class="mb-3">
                                            <label for="exampleFormControlTextarea1" class="form-label"></label>
                                            <textarea 
                        ...
                        <select 
                            ...
                            ref="tracking"
                          >
                            <option v-for="(n, index) in trackingList" :value="n.priority" :key="index" :selected="index === 0">{{ n.priority }}</option>
                        ...
                        <!-- <div class="mb-3">n
                            <label for="exampleFormControlInput1" class="form-label" style="font-size: 20px">Tracking</label>
                            <div style="margin:0 auto; width: 93%; text-align:center">
                            <input 
                                type="text" 
                                class="form-control" 
                                id="exampleFormControlInput1" 
                                placeholder="92353637372927927393749234"
                                required
                                v-model="tracking"                
                            >
                            </div>
...
export default {
    data() {
        return {
            senderInfo : {
                data : localStorage.getItem('sender') || '',
                fullName : '',
                houseAddress : '',
                city : '',
                state : '',
            ...
            customReceiver : {
                data: localStorage.getItem('c-receiver') || '',
                fullName: '',
                sortedData1: '',
                sortedData2: '',
                sortedData3: '',
    ...
    methods: {
        ...
        checkStoredSender(){
            let savedSender = localStorage.getItem('sender')
            return savedSender   
        },
        checkStoredWeight(){
        ...
        checkStoredCustomReceiver(){
            let savedCustomReceiver = localStorage.getItem('c-receiver')
        ...
        saveSenderInfo(){
            ...
            localStorage.setItem('sender', senderInfo)
            // this.refreshComponent()
            this.forceUpdatenow()
        ...
        saveCustomReceiver(){
            ...
            localStorage.setItem('c-receiver', customReceiver)
            // this.refreshComponent()
            this.forceUpdatenow()
        },
        saveReceiver(){
            let receiverInfo = {
                // info : this.receiverInfo.data,
                // infoApt : this.receiverInfo.apt
                info :[
        ...
        deleteSavedCustomReceiver(){
            localStorage.removeItem('c-receiver')
